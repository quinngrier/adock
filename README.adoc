...
.^a| Graphviz
.^a| link:test/diagram/graphviz/index.adoc[Example]
.^a| image::https://github.com/quinngrier/adock/actions/workflows/test-diagram-graphviz.yml/badge.svg[Graphviz test result]
